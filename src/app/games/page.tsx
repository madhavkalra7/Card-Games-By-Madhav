...
const GAMES: GameItem[] = [
  ...
  },
  {
    ...
    description: 'Iconic traditional get-away card game. Discard matching cards, avoid getting stuck with the highest card, and escape before becoming the Bhabho!',
  },
  {
    id: 'doctor',
    title: 'DOCTOR',
