        ...
        <form onSubmit={handleCreate} className="space-y-3 sm:space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-xl bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition-all text-xs sm:text-sm font-medium"
            />
          </div>
