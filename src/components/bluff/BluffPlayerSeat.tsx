    ...
    >
      ...
      <div className="relative">
        <div
          ...
          className={cn(
            ...
            isCurrentTurn && 'ring-3 sm:ring-4 ring-amber-400 ring-offset-1 sm:ring-offset-2 ring-offset-black shadow-gold-glow animate-pulse',
            isSpeaking && 'ring-3 sm:ring-4 ring-emerald-400 animate-pulse'
          )}
      ...
      <div className="flex flex-col items-center mt-0.5 sm:mt-1">
        <div className="flex items-center gap-0.5 sm:gap-1">
          ...
          {isSelf && (
            <span className="text-[7px] xs:text-[8px] bg-amber-400 text-black px-1 rounded font-black">
              YOU
            </span>
          )}
        </div>
        ...
        <div className="flex items-center gap-1 mt-0.5">
          ...
          {hasPassed && (
            <span className="text-[7px] xs:text-[8px] bg-zinc-800 text-zinc-400 border border-zinc-700 px-1 py-0.2 rounded font-bold uppercase">
              Passed
            </span>
          )}
          {isCurrentTurn && (
