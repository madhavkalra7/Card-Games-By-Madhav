...
export const ThrowablePicker: React.FC<ThrowablePickerProps> = ({
  ...
  return (
    <AnimatePresence>
      ...
      {/* Floating Centered Action Modal (Always 100% visible on all mobile screens and desktop!) */}
      <div
        onClick={(e) => e.stopPropagation()}
        className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[130] w-[92vw] max-w-sm pointer-events-auto select-none"
      >
        <motion.div
        ...
        >
          ...
          <span className="text-[9px] sm:text-[10px] text-zinc-400 font-bold mt-2">
